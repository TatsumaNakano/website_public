    ...
    return (
        <div className={styles.reference}>
            ...
            <div>
                ...
                <div>
                    {lang == "en" ? <p>{`I had the pleasure of working with Tatsuma Nakano for five years at my studio iBelieveInSwordfish. 
                    ...
                    {lang == "en" ? <p>{`companies like Facebook, Google, and Dolby, and everyone agreed that the results were stunning. 
                    ...
                    He never ceased to amaze me, and I know he will continue to amaze me with whatever he does in the future.`}</p> : null}

                    {lang == "ja" ? <p>{`私は五年間にわたり中野竜磨とiBelieveInSwordfishという私のスタジオで一緒に働くことができました。
                    ...
                    iPhoneでの拡張現実バージョンのためにApple ARKitにも移植しました。我々はFacebook、Google、Dolbyなどの企業のクライアントと結果を共有し、皆がその結果に感動しました。`}</p> : null}

                    {lang == "ja" ? <p>{
                        `卒業後、竜磨をクリエイティブテクノロジストとして正社員として採用しました。数か月のうちに、私たちの仕事はますますUnityやUnreal Engineに依存するようになり、
                    ...
                    彼が将来どのようなことを成し遂げるかが楽しみです。(訳ChatGPT3.5+修正)`}</p> : null}
